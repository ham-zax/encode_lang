...
- **Decode/explain for a human:** follow `prompt/DECODER.md`. `decode:`, `explain this packet`, or `what does this mean?` selects this role. Return an English reconstruction; represented work then executes as ordinary agent work when the surrounding host authorizes it.
